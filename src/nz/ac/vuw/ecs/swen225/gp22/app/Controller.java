...
public class Controller extends Keys{
    ...
    Controller(Player c){
        ...
        setAction(KeyEvent.VK_UP,() -> c.setDirection(Direction.Up),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_DOWN,() -> c.setDirection(Direction.Down),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_LEFT,() -> c.setDirection(Direction.Left),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_RIGHT,() -> c.setDirection(Direction.Right),() -> c.setDirection(Direction.None));

        //WASD also moves Chap within the maze
        setAction(KeyEvent.VK_W,() -> c.setDirection(Direction.Up),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_S,() -> c.setDirection(Direction.Down),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_A,() -> c.setDirection(Direction.Left),() -> c.setDirection(Direction.None));
        setAction(KeyEvent.VK_D,() -> c.setDirection(Direction.Right),() -> c.setDirection(Direction.None));
