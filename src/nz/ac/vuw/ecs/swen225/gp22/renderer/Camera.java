...
public class Camera {
   ...
   */
  private static final int visionSize = 9;
  /**
   * The distance in tiles the camera can see (from camera location).
   */
  private static final int visionDistance = (visionSize - 1) / 2;
  ...
  /**
   * Gets the x coordinate of the Camera in screen space. If the Camera has a valid animation
   * it returns the x coordinate from the Animation.
   *
  ...
  /**
   * Gets the y coordinate of the Camera in screen space. If the Camera has a valid animation
   * it returns the y coordinate from the Animation.
   *
