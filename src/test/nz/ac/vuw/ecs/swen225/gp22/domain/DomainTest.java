...
public class DomainTest {
  ...
  @Test
  public void EntityFactoryInvalidType() {
  ...
  @Test
  public void EntityFactoryNullType() {
    EntityFactory entityFactory = new EntityFactory();
    try {
  ...
  @Test
  public void EntityFactoryEmptyType() {
    EntityFactory entityFactory = new EntityFactory();
    try {
  ...
  @Test
  public void EntityFactoryNullPoint() {
    EntityFactory entityFactory = new EntityFactory();
    try {
  ...
  @Test
  public void EntityFactoryCreatePlayerUp() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreatePlayerDown() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreatePlayerLeft() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreatePlayerRight() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateRobotDown() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateRobotUp() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateRobotLeft() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateRobotRight() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateLava() {
    EntityFactory entityFactory = new EntityFactory();
    Entity entity = entityFactory.createEntity("LAVA", new Point(1, 1));
    Assert.assertNotNull(entity);
    assert entity instanceof LavaTile;
  }

  @Test
  public void EntityFactoryCreateExit() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateExitDoor() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateFloor() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateInfo() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateKeyYellow() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateKeyBlue() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateKeyGreen() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateKeyRed() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateDoorYellow() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateDoorBlue() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateDoorGreen() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateDoorRed() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateWall() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void EntityFactoryCreateTreasure() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void ActorMethodSetMoving() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void ActorMethodSetDirection() {
    EntityFactory entityFactory = new EntityFactory();
    Actor entity = (Actor) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
  ...
  @Test
  public void ActorMethodGetSprite() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void ActorMethodGetPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Actor entity = (Actor) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
  ...
  @Test
  public void ActorMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    Actor entity = (Actor) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
  ...
  @Test
  public void ActorMethodSetNullDirection() {
    EntityFactory entityFactory = new EntityFactory();
    Actor entity = (Actor) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
    try {
  ...
  @Test
  public void CollectableMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void CollectableMethodGetSprite() {
    EntityFactory entityFactory = new EntityFactory();
    Collectable entity = (Collectable) entityFactory.createEntity("TREASURE", new Point(1, 1));
  ...
  @Test
  public void CollectableMethodGetPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Collectable entity = (Collectable) entityFactory.createEntity("TREASURE", new Point(1, 1));
  ...
  @Test
  public void CollectableMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    Collectable entity = (Collectable) entityFactory.createEntity("TREASURE", new Point(1, 1));
  ...
  @Test
  public void CollectableMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    Collectable entity = (Collectable) entityFactory.createEntity("TREASURE", new Point(1, 1));
    try {
  ...
  @Test
  public void DoorMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void DoorMethodGetSprite() {
    EntityFactory entityFactory = new EntityFactory();
    Door entity = (Door) entityFactory.createEntity("DOOR_YELLOW", new Point(1, 1));
  ...
  @Test
  public void DoorMethodGetPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Door entity = (Door) entityFactory.createEntity("DOOR_YELLOW", new Point(1, 1));
    Assert.assertEquals(new Point(1, 1), entity.getPoint());
  }
  ...
  @Test
  public void DoorMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    Door entity = (Door) entityFactory.createEntity("DOOR_YELLOW", new Point(1, 1));
    Assert.assertEquals(1, entity.getDepth());
  }
  ...
  @Test
  public void DoorMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    Door entity = (Door) entityFactory.createEntity("DOOR_YELLOW", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  @Test
  public void ExitMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void ExitMethodGetSprite() {
    EntityFactory entityFactory = new EntityFactory();
    Exit entity = (Exit) entityFactory.createEntity("EXIT", new Point(1, 1));
  ...
  @Test
  public void ExitMethodGetPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Exit entity = (Exit) entityFactory.createEntity("EXIT", new Point(1, 1));
    Assert.assertEquals(new Point(1, 1), entity.getPoint());
  }
  ...
  @Test
  public void ExitMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    Exit entity = (Exit) entityFactory.createEntity("EXIT", new Point(1, 1));
    Assert.assertEquals(1, entity.getDepth());
  }
  ...
  @Test
  public void ExitMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    Exit entity = (Exit) entityFactory.createEntity("EXIT", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  @Test
  public void InfoMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void InfoMethodGetSprite() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
  ...
  @Test
  public void InfoMethodGetPoint() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
    Assert.assertEquals(new Point(1, 1), entity.getPoint());
  }
  ...
  @Test
  public void InfoMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
    Assert.assertEquals(1, entity.getDepth());
  }
  ...
  @Test
  public void InfoMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  @Test
  public void InfoMethodSetTextNull() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
    try {
      entity.setText(null);
  ...
  @Test
  public void InfoMethodSetTextEmpty() {
    EntityFactory entityFactory = new EntityFactory();
    InfoTile entity = (InfoTile) entityFactory.createEntity("INFO", new Point(1, 1));
    try {
      entity.setText("");
  ...
  @Test
  public void KeyMethodNotEquals() {
    EntityFactory entityFactory = new EntityFactory();
    Key entity = (Key) entityFactory.createEntity("KEY_YELLOW", new Point(1, 1));
  ...
  @Test
  public void PlayerMethodGetTreasure() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void PlayerMethodTreasures() {
    EntityFactory entityFactory = new EntityFactory();
    Player entity = (Player) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
  ...
  @Test
  public void ActorMethodGetMultipleSprites() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void PlayerMethodSetKeysNull() {
    EntityFactory entityFactory = new EntityFactory();
    Player entity = (Player) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
    try {
      entity.setKeys(null);
  ...
  @Test
  public void PlayerMethodTreasuresNegative() {
    EntityFactory entityFactory = new EntityFactory();
    Player entity = (Player) entityFactory.createEntity("PLAYER_UP", new Point(1, 1));
    try {
  ...
  @Test
  public void RobotMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void RobotMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    Robot entity = (Robot) entityFactory.createEntity("ROBOT_LEFT", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  /**
   * Lava Method Tests with valid inputs.
   */

  @Test
  public void LavaMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
    LavaTile entity = (LavaTile) entityFactory.createEntity("LAVA", new Point(1, 1));
    entity.setSoundEffect(Audio.getSoundPlayer("LAVA"));
    assert entity.soundEffect != null;
  }

  /**
   * Lava Method Tests with invalid inputs.
   */

  @Test
  public void LavaMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    LavaTile entity = (LavaTile) entityFactory.createEntity("LAVA", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  @Test
  public void PointMethodsTestAdd() {
  ...
  @Test
  public void PointMethodsTestEquals() {
    Point point = new Point(1, 1);
    assert point.equals(point);
  }

  @Test
  public void PointMethodsTestEqualsNull() {
    Point point = new Point(1, 1);
  ...
  @Test
  public void WallMethodSetSoundEffect() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void WallMethodGetDepth() {
    EntityFactory entityFactory = new EntityFactory();
    WallTile entity = (WallTile) entityFactory.createEntity("WALL", new Point(1, 1));
    entity.setSoundEffect(Audio.getSoundPlayer("WALL"));
  }
  ...
  @Test
  public void WallMethodSetSoundEffectNull() {
    EntityFactory entityFactory = new EntityFactory();
    WallTile entity = (WallTile) entityFactory.createEntity("WALL", new Point(1, 1));
    try {
      entity.setSoundEffect(null);
  ...
  @Test
  public void PlayerPingMethodKey() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void PlayerPingMethodTreasure() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodWall() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodLava() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    LavaTile wall = (LavaTile) entityFactory.createEntity("LAVA", new Point(1, 3));
    wall.setSoundEffect(Audio.getSoundPlayer("LAVA"));
    player.setMoving(true);
    List<Entity> gameEntities = Arrays.asList(wall, player);
    Model m = makeModel(gameEntities);
    player.ping(m);
  ...
  @Test
  public void PlayerPingMethodLockedDoor() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodLockedDoorOpen() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    LockedDoor door = (LockedDoor) entityFactory.createEntity("DOOR_YELLOW", new Point(1, 3));
  ...
  @Test
  public void PlayerPingMethodInfoTile() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodExit() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodExitDoor() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
  ...
  @Test
  public void PlayerPingMethodRobot() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    Robot robot = (Robot) entityFactory.createEntity("ROBOT_DOWN", new Point(1, 3));
    robot.setSoundEffect(Audio.getSoundPlayer("ROBOT"));
    player.setMoving(true);
    player.setTreasureCollected(10);
    List<Entity> gameEntities = Arrays.asList(robot, player);
    Model m = makeModel(gameEntities);
    player.ping(m);
  }
  ...
  @Test
  public void DoActionMethodExitDoor() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    ExitDoor exit = (ExitDoor) entityFactory.createEntity("DOOR_EXIT", new Point(1, 3));
    exit.setSoundEffect(Audio.getSoundPlayer("DOOR_EXIT"));
  ...
  @Test
  public void DoActionMethodExitDoorPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    ExitDoor exit = (ExitDoor) entityFactory.createEntity("DOOR_EXIT", new Point(1, 3));
    exit.setSoundEffect(Audio.getSoundPlayer("DOOR_EXIT"));
  ...
  @Test
  public void DoActionMethodExit() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    Exit exit = (Exit) entityFactory.createEntity("EXIT", new Point(1, 3));
    exit.setSoundEffect(Audio.getSoundPlayer("EXIT"));
  ...
  @Test
  public void DoActionMethodExitPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    Exit exit = (Exit) entityFactory.createEntity("EXIT", new Point(1, 3));
    exit.setSoundEffect(Audio.getSoundPlayer("EXIT"));
  ...
  @Test
  public void DoActionMethodKeyPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    Key key = (Key) entityFactory.createEntity("KEY_YELLOW", new Point(1, 3));
    key.setSoundEffect(Audio.getSoundPlayer("KEY"));
  ...
  @Test
  public void DoActionMethodWallPoint() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    WallTile wall = (WallTile) entityFactory.createEntity("WALL", new Point(1, 3));
    wall.setSoundEffect(Audio.getSoundPlayer("WALL"));
  ...
  @Test
  public void DoActionMethodTreasurePoint() {
    EntityFactory entityFactory = new EntityFactory();
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    Treasure treasure = (Treasure) entityFactory.createEntity("TREASURE", new Point(1, 3));
    treasure.setSoundEffect(Audio.getSoundPlayer("TREASURE"));
   ...
   */
  @Test
  public void RobotPingMethodWall() {
    EntityFactory entityFactory = new EntityFactory();
  ...
  @Test
  public void RobotPingMethodDoor() {
    EntityFactory entityFactory = new EntityFactory();
    Robot robot = (Robot) entityFactory.createEntity("ROBOT_RIGHT", new Point(1, 2));
    Door door = (Door) entityFactory.createEntity("DOOR_YELLOW", new Point(2, 2));
    door.setSoundEffect(Audio.getSoundPlayer("DOOR"));
    robot.setMoving(true);
    List<Entity> gameEntities = Arrays.asList(door, robot);
    Model m = makeModel(gameEntities);
    robot.ping(m);
    robot.ping(m);
    Assert.assertEquals(robot.getPoint(), new Point(1, 3));
  ...
  @Test
  public void RobotPingMethodPlayer() {
    EntityFactory entityFactory = new EntityFactory();
    Robot robot = (Robot) entityFactory.createEntity("ROBOT_RIGHT", new Point(1, 2));
    Player player = (Player) entityFactory.createEntity("PLAYER_RIGHT", new Point(2, 2));
    robot.setSoundEffect(Audio.getSoundPlayer("ROBOT"));
    robot.setMoving(true);
    player.setMoving(true);
    List<Entity> gameEntities = Arrays.asList(player, robot);
    Model m = makeModel(gameEntities);
    robot.ping(m);
  }
   ...
   */
  @Test
  public void FloorPingMethod() {
    EntityFactory entityFactory = new EntityFactory();
    FloorTile floor = (FloorTile) entityFactory.createEntity("FLOOR", new Point(1, 2));
    List<Entity> gameEntities = Arrays.asList(floor);
    Model m = makeModel(gameEntities);
    floor.ping(m);
  }

  @Test
  public void FloorSoundEffectMethod() {
    EntityFactory entityFactory = new EntityFactory();
    FloorTile floor = (FloorTile) entityFactory.createEntity("FLOOR", new Point(1, 2));
    floor.setSoundEffect(Audio.getSoundPlayer("DOOR"));
  }

  @Test
  public void FloorDoActionMethod() {
    EntityFactory entityFactory = new EntityFactory();
    FloorTile floor = (FloorTile) entityFactory.createEntity("FLOOR", new Point(1, 2));
    Player player = (Player) entityFactory.createEntity("PLAYER_DOWN", new Point(1, 2));
    player.setMoving(true);
    List<Entity> gameEntities = Arrays.asList(floor, player);
    Model m = makeModel(gameEntities);
    floor.doAction(m, player, new Point(1, 6));
  }

  @Test
  public void FloorCheckRobotMoveMethod() {
    EntityFactory entityFactory = new EntityFactory();
    FloorTile floor = (FloorTile) entityFactory.createEntity("FLOOR", new Point(1, 2));
    Robot robot = (Robot) entityFactory.createEntity("ROBOT_RIGHT", new Point(1, 2));
    robot.setMoving(true);
    List<Entity> gameEntities = Arrays.asList(floor, robot);
    Model m = makeModel(gameEntities);
    floor.checkRobotMove(m, robot, new Point(1, 6));
  }
